...
<html lang="en" lang="fr">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="#">Ao XIE</a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              ...
              <p>I will update my technology-related progress here, which will include relevant projects I have completed. In the future, you will also find my relevant papers and the process of their realisation on this website. If you want to know more about me, feel free to visit my private website.</p>
              <p><a class="btn btn-primary btn-lg" href="#" role="button">Artistic Career »</a></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            ...
            <p>Here are the projects I have completed so far.</p>
          </div>
        </div>
      </div>
    </section>
            ...
            <ul class="list-unstyled">
              <li class="media">
                ...
                <div class="media-body">
                  <h5 class="mt-0 mb-1">YOLOv3-based road traffic sign detection</h5>
                  Traffic sign detection based on YOLOv3 and Tencent-Tsinghua TT100k dataset.
                </div>
              </li>
            </ul>
          </div>
          <div class="col-md-4 col-12">
            <ul class="list-unstyled">
              <li class="media">
                <img class="mr-3" src="images/35X35.gif" alt="Generic placeholder image">
                <div class="media-body">
                  <h5 class="mt-0 mb-1">Neural networks based entirely on Numpy</h5>
                  A neural network model done in Numpy only.
                </div>
              </li>
            </ul>
          </div>
